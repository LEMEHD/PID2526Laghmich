...
class TestKnowledgeBaseService {
    ...
    @Autowired private IKbCourseDao kbCourseDao; // <--- AJOUT CRUCIAL
    ...
    void setUp() {
        ...
        ulb = KbSchool.builder()
                ...
                .build();
        ulb = schoolDao.save(ulb); // Capture de l'instance gérée
        ...
        section = sectionDao.save(section); // Capture de l'instance gérée
    ...
    private void createRule(String description, KbSchool school, String sourceCode, int minEcts, UE targetUE) {
        ...
        srcCourse = kbCourseDao.save(srcCourse); // <--- CORRECTION: Sauvegarde explicite ici aussi
