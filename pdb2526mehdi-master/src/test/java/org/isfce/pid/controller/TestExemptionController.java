...
public class TestExemptionController {
    ...
    // Utilisation de @MockBean qui est le standard Spring Boot pour simuler un Bean du contexte
    @MockitoBean
    ...
    void testGetRequestDetail_Success() throws Exception {
        ...
        // Appel de la méthode réelle de ton service : getRequestDetail
    ...
    void testGetRequestDetail_NotFound() throws Exception {
        ...
        // Ton MonAdviceRestController transforme EntityNotFoundException en 404
        mockMvc.perform(get("/api/exemptions/{reqId}", reqId))
    ...
    void testAddManualItem_DuplicateError() throws Exception {
        ...
        // Simulation : Le service lève ton exception DuplicateException(msg, champ)
        when(exemptionService.addManualItem(eq(reqId), any()))
                .thenThrow(new DuplicateException("Dispense déjà demandée", "ueCode"));

        // Ton MonAdviceRestController intercepte DuplicateException et renvoie :
